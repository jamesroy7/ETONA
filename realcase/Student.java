...
if(field.getText().isEmpty()){
    ...
    JOptionPane.showConfirmDialog(null, "ENTER AMMOUNT", "ERROR MESSAGE", JOptionPane.CLOSED_OPTION, JOptionPane.ERROR_MESSAGE, icon3);
}
...
}else if (ch==1)
{
 ...
 JOptionPane.showMessageDialog(null,"THANKYOU FOR USING TSU CURRENCY CONVERTER", "THANKYOU!!!", JOptionPane.OK_OPTION, icon4);
this.dispose();
}
